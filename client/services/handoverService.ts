...
export async function saveHandover(payload: HandoverPayload): Promise<HandoverResponse> {
  try {
    ...
    console.log('📤 Saving handover to Supabase:', {
      ...handoverData,
    ...
    console.log('✅ Handover saved to Supabase:', data);
    return {
      success: true,
      data
    };
    ...
    console.error('❌ Error in saveHandover:', error);
    return {
      success: false,
...
export async function deleteHandover(handoverId: string): Promise<HandoverResponse> {
  try {
    ...
    if (error) {
      console.error('❌ Supabase error deleting handover:', error);
      return {
        success: false,
        error: error.message
      };
    ...
    console.log('✅ Handover deleted from Supabase:', data);
    return {
      success: true,
      data
    };
...
export async function updateHandover(
  ...
  try {
    ...
    console.log('📤 Updating handover in Supabase:', {
      handoverId,
      updateData
    });
    ...
    console.log('✅ Handover updated in Supabase:', data);
    return {
      success: true,
      data
    };
...
export async function submitHandoverToWebhook(payload: any): Promise<{ success: boolean; error?: string }> {
  try {
    ...
    const response = await fetch('http://localhost:5678/webhook/handover-submit', {
      method: 'POST',
      headers: {
    ...
    console.log('✅ Handover submitted to webhook:', data);
