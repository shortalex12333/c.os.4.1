...
interface EmailCardCollapsedLightProps {
  title?: string;
  senderName?: string;
  senderEmail?: string;
  date?: string;
...
export default function EmailCardCollapsedLight({
  ...
  return (
    <div className="w-full" style={{ maxWidth: emailCard.collapsed.width, margin: '0 auto' }}>
      {/* Email Card Container - EXACT 904 × 175 from reference */}
      <div 
        style={{
          position: 'relative',
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'start', gap: cardConfig.controlSize }}>
          <div 
            style={{
              backgroundColor: '#CDCDCD', // User avatar background from reference
              borderRadius: '50%',
