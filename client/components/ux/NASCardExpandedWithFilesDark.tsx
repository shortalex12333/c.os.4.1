...
interface NASCardExpandedWithFilesDarkProps {
  title?: string;
  description?: string;
...
export default function NASCardExpandedWithFilesDark({
  ...
  onFileClick,
  onAskAI
}: NASCardExpandedWithFilesDarkProps) {
  return (
            ...
            <div style={{ paddingRight: 32 }}>
              {files.map((file, index) => (
                <div key={index} className="flex items-center" style={{ gap: 12, marginBottom: 8 }}>
                  ...
                  >
                    <FileText size={14} style={{ color: designTokens.colors.dark.secondaryText }} />
                  </div>
                  <button
            ...
            <div className="absolute" style={{ right: 16, top: 16 }}>
              <div 
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor: designTokens.colors.dark.cardBackground,
                  boxShadow: '0_2px_4px_0_rgba(0,0,0,0.2)',
                  padding: 4
                }}
              >
                <div 
