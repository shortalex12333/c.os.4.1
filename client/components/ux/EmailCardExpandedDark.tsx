...
interface EmailCardExpandedDarkProps {
  title?: string;
  description?: string;
  summaryTitle?: string;
  summaryItems?: string[];
...
export default function EmailCardExpandedDark({
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 24 }}>
            ...
            <div className="flex items-center" style={{ gap: 8 }}>
              <Paperclip size={18} style={{ color: designTokens.colors.dark.secondaryText }} />
              <span 
                style={{
                  fontSize: 20,
                  color: designTokens.colors.dark.secondaryText,
