...
interface AIResponseCardDarkProps {
  answer: string;
  sources?: AISource[];
  modelUsed?: string;
  reasoning?: string;
...
export default function AIResponseCardDark({
              ...
              {sources.map((source, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {source.relevance && (
                      <span style={{ color: designTokens.colors.dark.secondaryText, marginLeft: 8 }}>
