...
interface EmailCardWithAttachmentsLightProps {
  title?: string;
  description?: string;
  summaryTitle?: string;
  summaryItems?: string[];
...
export default function EmailCardWithAttachmentsLight({
  ...
  onLeaveFeedback,
  onAttachmentClick
}: EmailCardWithAttachmentsLightProps) {
  return (
          ...
          <div style={{ paddingRight: 32 }}>
            {attachments.map((attachment, index) => (
              <div key={index} className="flex items-center" style={{ gap: 8, marginBottom: 8 }}>
                <span style={{ fontSize: 16, color: '#616874' }}>⌕</span>
                <button
          ...
          <div className="absolute" style={{ right: 16, top: 16 }}>
            <div 
              style={{
                ...
                borderRadius: 8,
                backgroundColor: 'white',
                boxShadow: '0_4px_4px_0_rgba(0,0,0,0.04)',
                padding: 4
              }}
            >
              <div 
