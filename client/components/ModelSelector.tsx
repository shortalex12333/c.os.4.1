...
interface ModelSelectorProps {
  isMobile?: boolean;
  isDarkMode?: boolean;
  selectedModel?: string; // Accept current selected model from parent
...
export function ModelSelector({ isMobile = false, isDarkMode = false, selectedModel = 'air', onModelChange }: ModelSelectorProps) {
